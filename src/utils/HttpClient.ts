 ...
 * @LastEditTime: 2020-04-27 11:08:02
 */
  ...
  public postForm<T>(url: string, data?: object): Promise<AjaxResponse<T>> {
    return this.post<T>(url, qs.stringify(data || {}), {
      headers: {
        ...
        'Content-Type': 'multipart/form-data;boundary=------WebKitFormBoundary7GG13CbXqRU3GnLb'
      },
    });
  }

  public postJSON<T>(url: string, data?: object|string): Promise<AjaxResponse<T>> {
